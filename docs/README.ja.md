...
npm 互換のメタデータは用意されていますが、npm パッケージはまだ公開されていません。告知までは GitHub のソースリポジトリが v0.1.0 の正式な配布元です。ES Modules、Custom Elements、SVG、Pointer Events、Web Animations API をサポートするモダンブラウザーを対象とします。
